...
class Process implements Comparable<Process>{
	...
	public Process(SJF s,String name, int priority, int arr,int burst, String color) {
		sc = s;
...
LP3 Violet 25 72 4
	...
	public static ArrayList<Process> createP(int n) {
		...
		System.out.println("Enter Name - color - arrival - burst time:");
...
public class SJF {
	...
	private void GUI() {
		...
		frame = new JFrame("SJF Scheduler");
